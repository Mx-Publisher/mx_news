...
<!-- BEGIN preview -->
<br />
<table cellpadding="4" class="tablebg forumline" width="100%" border="0" cellpadding="4" cellspacing="0" >
	<tr>
...
<table cellpadding="4" class="table1 tablebg forumline" border="0" cellpadding="4" cellspacing="0" >
	<tr>
